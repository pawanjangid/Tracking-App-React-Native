...
import { Text, View,StyleSheet,Image,SafeAreaView,TouchableHighlight, Alert } from 'react-native';
      ...
      <DrawerContentScrollView style={styles.drawerContainer} {...props}>
        <View style={styles.HeaderContainer}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.text}>Pawan Kumar Jangid</Text>
          </View>
        </View>
        <DrawerItemList {...props} itemStyle={{padding:1,paddingLeft:15,borderRadius:15}}  activeTintColor='white' activeBackgroundColor='#000473' inactiveTintColor='rgba(0, 0, 0, .87)' inactiveBackgroundColor='transparent' labelStyle={{fontSize:14,fontWeight:"bold"}} />
  ...
  return (
    <NavigationContainer >
        ...
        <Drawer.Screen name="Settings" component={Settings} options={{
                drawerIcon:(tabInfo)=><AntDesign name="setting" size={24} color={tabInfo.focused ? "white":"black"} />
            }} />
      </Drawer.Navigator>
    </NavigationContainer>
  );
